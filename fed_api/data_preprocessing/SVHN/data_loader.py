...
from .datasets import SVHN_custom
...
def load_SVHN_data(datadir):
    ...
    SVHN_train_ds = SVHN_custom(datadir, train=True, download=True, transform=train_transform)
    SVHN_test_ds = SVHN_custom(datadir, train=False, download=True, transform=test_transform)
...
def get_dataloader(dataset, datadir, train_bs, test_bs, vit_flag, dataidxs=None):
    return get_dataloader_SVHN(datadir, train_bs, test_bs, vit_flag, dataidxs)
...
def get_dataloader_SVHN(datadir, train_bs, test_bs, vit_flag, dataidxs=None):
    dl_obj = SVHN_custom

    if vit_flag:
        transform_train, transform_test = _data_transforms_SVHN_vit()
    else:
